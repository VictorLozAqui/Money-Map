            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4 pb-6 border-b border-gray-200">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-base font-semibold text-gray-900 break-all">{userData?.email}</p>
                </div>
              </div>
              ...
              {family && (
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium text-gray-500 mb-1">Família</p>
                    <p className="text-base font-semibold text-gray-900">{family.nome}</p>
                  </div>
                </div>
              )}
            </div>
